...
import { CodePane, Code, Heading, Slide } from 'spectacle';
...
export const easingSlides = [
  ...
  <Slide bgColor="secondary">
    <Heading size={6} lineHeight={lh.title} textColor="primary">
      An easing function drives the relationship between time and the
    ...
    ranges={[
      {
        ...
        title: (
          <span>
            Penner’s Equations<br />
            <span className="white f2 ttu tracked">
      ...
      },
      {
        ...
        title: 'Current Time',
        note:
          'In seconds or frames or whatever – as long you use the same unit as the total time.',
      },
      {
        loc: [0, 1],
        title: 'Start Value',
...
function ease(currentTime, startValue, delta, duration) {
  ...
  <Slide>
    <Heading size={6} textColor="tertiary" margin={s.b4}>
      Bounce
    </Heading>
    <CodePane
      textSize="1.25rem"
